...
const Footer = props => {
  const footerLinks = {
    ...
    contact: [
      {
        link:
          "https://www.google.ng/maps/place/16+Fola+Jinadu+Cres,+Pedro,+Lagos/@6.5490039,3.3747902,17z/data=!3m1!4b1!4m8!1m2!2m1!1s16A+Fola+Jinadu+street,+UPS+Bus-stop,+Gbagada,+Lagos.!3m4!1s0x103b8d9e57518473:0x568474215af7416c!8m2!3d6.5489986!4d3.3769789",
        text: "16A Fola Jinadu street, UPS Bus-stop, Gbagada, Lagos."
      },
      {
        link: "mailto:info@bookiT.com",
        text: "info@bookiT.com"
      },
      { link: "tel:08023995138", text: "08023995138" }
    ]
  };
    ...
    <footer className="footer-parent">
      <div className="trusted-brands-story">
        <div>
          <p>
            <q>
              ...
              sporting facilities. As such, it can be complicated to link in the
              varoius facilities together so that it remains user friendly
              whilst also being functional. Book!T has managed to help achieve
              this and i have found that they have always responded in a timely
              manner with all our queries too
            </q>
          </p>
        ...
        <div>
          <p>
            <q>
              We use Book!T in our four workspaces; Cairo, Lagos, Accra, and
              Cape Town. Our travelling communities find it quick to view which
              meeting rooms and phone booths are free on a daily basis. Before
              Book!T, we were using Google Calender to manage rooms, Now we are
              able to centralize the workspaces which helps our growing
              communities book without interrupting their workflow or crowding
              their work calender.
            </q>
          </p>
          <div className="logo-company-container">
        ...
        <div>
          <p>
            <q>
              Book!T is a deceivingly powerful space-management solution made
              simple by an intuitive user interface. As a studio with an
              incredibly dynamic schedule and a variety of needs. Book!T has all
              but eliminated space-scheduling conflicts. This has had an
              important positive impact on departmental cooperation and employee
              morale.
            </q>
          </p>
          <div className="logo-company-container">
